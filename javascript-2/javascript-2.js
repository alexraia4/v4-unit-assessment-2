...
//CODE HERE
let orderTotal = blueProducts.reduce((acc, element) => acc += element.price, 0);
//////////////////////////////////PROBLEMS 5-8//////////////////////////////////
/*
...
//CODE HERE
let {name, phoneNumber, email} = ellensInfo;
////////////////////PROBLEM 8////////////////////
/*
...
//CODE HERE
let {street, city, state, zipCode} = shippingInfo;
//////////////////////////////////PROBLEMS 9-11//////////////////////////////////
/*
...
let person = {
  name: 'Henry',
  age: 72,
  jobs: ['Car Manufacturer', 'Artist', 'Inventor'],
  birthday: function(){
    this.age += 1;
  },
  favorites: {
  ...
  kids: [{name: 'John', age: 7}, {name: 'Penny', age: 13}]
}
